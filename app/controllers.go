...
func MountContainerForAPIController(service *goa.Service, ctrl ContainerForAPIController) {
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Create", "route", "GET /api/v2/container/create", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Download", "route", "GET /api/v2/container/:id/download", "security", "api_key")
	service.Mux.Handle("HEAD", "/api/v2/container/download", ctrl.MuxHandler("download", h, nil))
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Download", "route", "HEAD /api/v2/container/download", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Exec", "route", "GET /api/v2/container/:id/exec", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "GetConfig", "route", "GET /api/v2/container/:id/config", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Inspect", "route", "GET /api/v2/container/:id/inspect", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "List", "route", "GET /api/v2/container/list", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Logs", "route", "GET /api/v2/container/:id/logs", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Remove", "route", "GET /api/v2/container/:id/remove", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "SetConfig", "route", "POST /api/v2/container/:id/config", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Start", "route", "GET /api/v2/container/:id/start", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Stop", "route", "GET /api/v2/container/:id/stop", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "ContainerForAPI", "action", "Upload", "route", "POST /api/v2/container/:id/upload", "security", "api_key")
}
...
func MountSwaggerController(service *goa.Service, ctrl SwaggerController) {
	...
	h = ctrl.FileHandler("/swagger/swagger.json", "./swagger/swagger.json")
	h = handleSwaggerOrigin(h)
	service.Mux.Handle("GET", "/swagger/swagger.json", ctrl.MuxHandler("serve", h, nil))
	service.LogInfo("mount", "ctrl", "Swagger", "files", "./swagger/swagger.json", "route", "GET /swagger/swagger.json")

	h = ctrl.FileHandler("/swagger/swagger.yaml", "./swagger/swagger.yaml")
	h = handleSwaggerOrigin(h)
	service.Mux.Handle("GET", "/swagger/swagger.yaml", ctrl.MuxHandler("serve", h, nil))
	service.LogInfo("mount", "ctrl", "Swagger", "files", "./swagger/swagger.yaml", "route", "GET /swagger/swagger.yaml")
}
...
func MountUserForAPIController(service *goa.Service, ctrl UserForAPIController) {
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "AddAuthorizedKeys", "route", "PUT /api/v2/user/config/authorizedKeys", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "GetConfig", "route", "GET /api/v2/user/config", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "GetDefaultShell", "route", "GET /api/v2/user/config/defaultShell", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "ListAuthorizedKeys", "route", "GET /api/v2/user/config/authorizedKeys", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "RemoveAuthorizedKeys", "route", "DELETE /api/v2/user/config/authorizedKeys", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "SetAuthorizedKeys", "route", "POST /api/v2/user/config/authorizedKeys", "security", "api_key")
	...
	service.LogInfo("mount", "ctrl", "UserForAPI", "action", "SetDefaultShell", "route", "POST /api/v2/user/config/defaultShell", "security", "api_key")
}
