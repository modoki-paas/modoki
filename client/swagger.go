...
//
// API "Modoki API": swagger Resource Client
//
// Command:
// $ goagen
...
func (c *Client) DownloadSwaggerJSON(ctx context.Context, dest string) (int64, error) {
	...
	u := url.URL{Host: c.Host, Scheme: scheme, Path: "/frontend/v2/swagger/swagger.json"}
...
func (c *Client) DownloadSwaggerYaml(ctx context.Context, dest string) (int64, error) {
	...
	u := url.URL{Host: c.Host, Scheme: scheme, Path: "/frontend/v2/swagger/swagger.yaml"}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return 0, err
	}
